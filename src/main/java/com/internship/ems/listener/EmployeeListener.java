...
public class EmployeeListener {
    ...
    private void beforePost(Employee employee) {
        log.info("On the way to processing employee data");
    }

    @PreUpdate
    private void beforeUpdate(Employee employee) {
        log.info("Updating employee data: " + employee.getEmployeeId());
    }

    @PreRemove
    private void beforeRemove(Employee employee) {
        log.info("Deleting employee data: " + employee.getEmployeeId());
    }
